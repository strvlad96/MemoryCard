...
def check_answer():
    ...
    if answers[0].isChecked():
        # правильный ответ!
        points += 1
        show_correct('Правильно! Your score ' + str(points) + ' points')
    else:
...
def next_question():
    ...
    window.cur_question = randint(0, len(questions_list)-1) # переходим к следующему вопросу # если список вопросов закончился - идем сначала
